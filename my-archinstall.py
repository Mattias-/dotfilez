...
archinstall.arguments["mirror-region"] = "Sweden"
archinstall.arguments["timezone"] = "Europe/Stockholm"
archinstall.arguments["nic"] = "Copy ISO network configuration to installation"
archinstall.arguments["hostname"] = "my-machine"
...
if hasUEFI() is False:
    archinstall.log(
        "ArchInstall currently only supports machines booted with UEFI.\nMBR & GRUB support is coming in version 2.2.0!",
        fg="red",
        level=archinstall.LOG_LEVELS.Error,
    )
    exit(1)
